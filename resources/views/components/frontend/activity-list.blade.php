                ...
                <div class="row text-inter">
                    <div class="col-12 my-2">
                        @if (str_contains($url, 'category'))
                            <h1 class="fw-bold text-header-pink">Kategori kegiatan : {{ $explodedTitle[2] }}</h1>
                        @else
                            <h1 class="fw-bold text-header-pink">Kegiatan Saya</h1>
                        @endif
                    </div>
                </div>
            </div>
                        ...
                        <div class="card border-0 shadow-sm card-recent-activity">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-grid gap-2">
                                    <a href="{{ route('activity.detail', 'slug') }}"
